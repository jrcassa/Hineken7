...
export class USyncQuery {
	...
	parseUSyncQueryResult(result: BinaryNode, ignoreErrors?: boolean): USyncQueryResult | undefined {
					...
					? Object.fromEntries(
							node.content
								.map(content => {
									...
									if (ignoreErrors && Array.isArray(content.content) && content.content[0]?.tag === 'error') {
