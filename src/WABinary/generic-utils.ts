...
export const getBinaryFilteredButtons = (nodeContent): BinaryNode => {
...
export const assertNodeErrorFree = (node: BinaryNode, ignoreErrors?: boolean) => {
	const errNode = getBinaryNodeChild(node, 'error')
	if (errNode && !ignoreErrors) {
